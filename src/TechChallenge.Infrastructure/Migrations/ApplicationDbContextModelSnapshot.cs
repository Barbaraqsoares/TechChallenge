...
partial class ApplicationDbContextModelSnapshot : ModelSnapshot
{
    ...
    {
        modelBuilder.HasAnnotation("ProductVersion", "8.0.30").HasAnnotation("Relational:MaxIdentifierLength", 128);

        SqlServerModelBuilderExtensions.UseIdentityColumns(modelBuilder);

        modelBuilder.Entity("GamePromotion", b =>
        {
            b.Property<int>("GamesId").HasColumnType("int");
            b.Property<int>("PromotionsId").HasColumnType("int");
        ...
        modelBuilder.Entity("TechChallenge.Domain.Entity.Game", b =>
        {
            ...
            b.Property<bool>("IsMultiplayer").HasColumnType("bit");
            b.Property<string>("Name").IsRequired().HasColumnType("nvarchar(100)");
        ...
        modelBuilder.Entity("TechChallenge.Domain.Entity.User", b =>
        {
            ...
            b.Property<string>("Email").IsRequired().HasMaxLength(100).HasColumnType("varchar(100)");
            b.Property<string>("Login").IsRequired().HasMaxLength(50).HasColumnType("varchar(50)");
            b.Property<string>("Name").IsRequired().HasMaxLength(100).HasColumnType("varchar(100)");
            b.Property<string>("Password").IsRequired().HasMaxLength(50).HasColumnType("varchar(50)").HasColumnName("Password");
        ...
        modelBuilder.Entity("TechChallenge.Domain.Entity.UserGame", b =>
        {
            ...
            SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));
            b.Property<DateTime>("CreatedAt").HasColumnType("datetime2");
            b.Property<int>("GameId").HasColumnType("int");
