...
namespace TechChallenge.Infrastructure.Repository.Configuration
{
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(t => t.Name).IsRequired().HasMaxLength(100).HasColumnType("varchar(50)");
            builder.Property(t => t.Email).IsRequired().HasMaxLength(100).HasColumnType("varchar(50)");
            builder.Property(t => t.Login).HasMaxLength(50).HasColumnType("varchar(50)");
            builder.Property(t => t.Password).IsRequired().HasMaxLength(50).HasColumnType("varchar(50)");
